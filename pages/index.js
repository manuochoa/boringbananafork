      ...
      <div className="md:w-2/3 w-4/5 " id="about">
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-around items-center">
            <div className="lg:w-1/2 w-3/4">
              <h1 className="text-7xl Poppitandfinchsans text-white ">
                EVERYONE, meet <br />
                <span className="text-blau">boring bananas</span>
              </h1>
              <p className="text-2xl text-white my-6  montserrat">
                Here at <span className="text-5xl Poppitandfinch ">boring</span>{" "}
                <span className="text-blau text-5xl Poppitandfinchsans">
                  Bananas
                </span>{" "}
                <span className="text-5xl Poppitandfinch">company</span>, we
                specialize in the world's{" "}
                <span className="text-span-2 font-bold">
                  finest digital bananas
                </span>
                .<br />‍<br />
                We&#x27;ve put together a team spanning 3 continents, to bring
                you some of the most <br />‍
                <span className="text-blau text-5xl Poppitandfinchsans">
                  NUTRITIOUS{" "}
                </span>
              ...
              <p className="text-2xl text-white my-6  montserrat">
                ...
                <span className="text-white text-2xl montserrat">
                  <strong>TOTAL SUPPLY: 8888</strong> Bananas.
                  <br />
                  <strong>PRICE: 0.025 ETH </strong>each.
                </span>
              </p>
              <iframe
                src="https://free.timeanddate.com/countdown/i7vcex5b/n107/cf11/cm0/cu4/ct0/cs1/ca2/co0/cr0/ss0/cacfff/cpcfff/pct/tcfff/fn3/fs100/szw448/szh189/iso2021-06-29T21:00:00"
        ...
        >
          ...
          <div className="flex flex-col justify-between mx-6 sm:w-1/2 w-4/5 py-6 ">
            ...
            <p className="text-xl text-white my-6  montserrat">
              ...
              several <span className="font-bold"> banana species </span> have
              begun exhibiting{" "}
              <span className="font-bold"> strange characteristics. </span> Our
              research team located across the globe has commenced efforts to{" "}
        ...
        <div id="roadmap" className="">
          ...
          <p className="text-xl text-white my-6  montserrat">
            ...
            <span className="text-5xl Poppitandfinch ">boring</span>{" "}
            <span className="text-blau text-5xl Poppitandfinchsans">
              Bananas
            </span>{" "}
            <span className="text-5xl Poppitandfinch">company</span> after{" "}
            <a
              target="_blank"
              href="https://twitter.com/thedigitalvee/status/1405896585142280192"
          ...
          <p className="text-xl text-white my-6  montserrat">
            ...
            <span className="font-bold"> 60 ETH </span> from primary sales.
          </p>
          ...
          <ul className="">
            <li className="text-xl text-white my-6  montserrat">
              <span className="font-bold"> 4 x 10 ETH donations: </span> The
              first of these will be made to{" "}
              <a
                target="_blank"
              ...
              , working to empower young women and{" "}
              <span className="font-bold"> close the gender gap </span> in
              technology. We know women are unrepresented in the NFT space -
              lets help to fix this! The remaining donations will be made via
              community vote using{" "}
              <a
                target="_blank"
            ...
            <li className="text-xl text-white my-6  montserrat">
              <span className="font-bold"> 20 ETH to Community Wallet: </span>{" "}
          ...
          <p className="text-xl text-white my-6  montserrat">
            ...
            <span className="font-bold underline">
              {" "}
              high quality content for the NFT community{" "}
            </span>{" "}
            through our{" "}
            <span className="font-bold underline">
              {" "}
          ...
          <p className="text-xl text-white my-6  montserrat">
            {" "}
            All fully annotated source code for image generation and the smart
            contract will be made available after launch as a community
            resource.
          </p>
        </div>
        ...
        <div id="team" className="mx-12 my-16 ">
          ...
          <div className="flex justify-around flex-wrap">
            <div className="flex flex-col  my-6" style={{ width: "360px" }}>
              ...
              <a
                href="https://twitter.com/thedigitalvee"
            ...
            <div className="flex flex-col  my-6" style={{ width: "360px" }}>
              ...
              <a
                href="https://twitter.com/champagneman"
                className="text-center text-4xl text-center Poppitandfinchsans underline text-white"
              >
                {" "}
                (@champagneman)
            ...
            <div className="flex flex-col  my-6" style={{ width: "360px" }}>
              ...
              <a
                href="https://twitter.com/madboogieart"
                className="text-center text-4xl text-center Poppitandfinchsans underline text-white"
              >
                {" "}
                (@madboogieart)
            ...
            <div className="flex flex-col  my-6" style={{ width: "360px" }}>
              ...
              <a
                href="https://twitter.com/mz09art"
                className="text-center text-4xl text-center Poppitandfinchsans underline text-white"
              >
                {" "}
                (@mz09art)
            ...
            <div className="flex flex-col  my-6" style={{ width: "360px" }}>
              ...
              <a
                href="https://twitter.com/berkozdemir"
                className="text-center text-4xl text-center Poppitandfinchsans underline text-white"
              >
                {" "}
                (@berkozdemir)
          ...
          <div className="flex flex-col justify-between mx-6 sm:w-1/2 w-4/5 py-6 ">
            ...
            <p className="text-xl text-white my-6  montserrat">
              ...
              <a
                ...
                target="_blank"
                href="mailto:boringbananas69@gmail.com"
              >
                boringbananas69@gmail.com
              </a>
              ,<br />
